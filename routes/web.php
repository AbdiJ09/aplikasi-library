...
use App\Livewire\Pengembalian\Index as PengembalianIndex;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
Route::middleware('auth', 'role:user')->group(function () {
    ...
    Route::get('/dashboard/buku-kelas', function () {
        return view('dashboard.buku-kelas.index');
    })->name('buku-kelas');
