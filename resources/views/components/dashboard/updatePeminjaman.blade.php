   <dialog id="update_peminjaman{{ $peminjaman->id }}" class="modal">
       <div class="modal-box w-11/12 max-w-5xl lg:overflow-hidden">
           <h3 class="font-bold text-xl text-center text-white uppercase tracking-wide">Update Peminjaman</h3>
               ...
               <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                   ...
                   <div>
                       ...
                       <input type="text" id="lama_pinjam"
                           ...
                           required name="lama_pinjam" value="{{ $peminjaman->lama_pinjam }}">
                   </div>

                   <div class="w-full">
                       <label for="buku_id" class="block mb-2 text-sm font-medium text-white">Buku</label>
                       <button id="listBukuUpdate" data-dropdown-toggle="listBuku{{ $peminjaman->id }}"
                                   ...
                                   <li>
                                       <div
                                           ...
                                           <input id="checkbox-item-{{ $item->id }}" type="checkbox"
                                               ...
                                               {{ in_array($item->id, $peminjaman->PeminjamanDetail->pluck('buku_id')->toArray()) ? 'checked' : '' }}>
                   ...
                   <div class="lg:col-span-3">
                       ...
                       <textarea id="keterangan" rows="4"
                           ...
                           placeholder="Write your thoughts here..." name="keterangan">{{ $peminjaman->keterangan }}</textarea>
