      <div class="px-5 pt-5">
          ...
          @can('admin')
              <button class="btn bg-white rounded-xl text-black">Tambah buku +</button>
          @endcan
                  ...
                  @for ($i = 0; $i < 5; $i++)
                      <div
                          ...
                          <div
                              ...
                              <h1 class="font-dmserif text-xl md:text-2xl font-bold text-white">Bahasa Indonesia</h1>
                              ...
                              <button
                                  class="rounded-full bg-neutral-900 py-2 px-3.5 font-com text-sm capitalize text-white shadow shadow-black/60 mt-2"
                                  onclick="my_modal_2.showModal()">See
                                  More</button>
                          </div>
                      </div>
                      <div
                          ...
                          <div
                              class="absolute inset-0 flex translate-y-[63%] md:translate-y-[54%] flex-col items-center justify-center px-9 md:px-0 text-center transition-all duration-500 group-hover:translate-y-0">
                              <h1 class="font-dmserif text-xl md:text-2xl font-bold text-white">Matematika</h1>
      ...
      <dialog id="my_modal_2" class="modal">
          <div class="modal-box  bg-no-repeat bg-cover rounded-xl flex flex-col md:flex-row max-w-[40rem]"
              style="background-image: url('/img/bgg.png')">
              <img src="/img/buku/bIndo.jpg" class="rounded-lg w-2/4 mx-auto md:w-2/5 md:mx-0" alt="">
              <div class="px-3">
                  <h1 class="text-neutral-100  text-lg font-Inter">Judul : <span class="font-bold tracking-wide">Bahasa
                          Indonesia</span></h1>
