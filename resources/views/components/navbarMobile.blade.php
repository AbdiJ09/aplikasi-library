   <ul class="lg:hidden absolute top-full p-4 shadow-lg right-4 max-w-[200px] md:max-w-[300px] w-full rounded-lg bg-black text-start scale-0 transition duration-300 ease-in-out md:space-y-3"
       id="nav">
