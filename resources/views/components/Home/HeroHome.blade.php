      ...
      <div class="flex flex-col">
          ...
          <button
              class="cursor-pointer transition-all mt-3 bg-gray-900 md:bg-gray-700 text-white px-6 py-2 rounded-lg
                        ...
                        active:border-b-[2px] active:brightness-90 active:translate-y-[2px] hover:shadow-lg hover:shadow-purple-300 shadow-purple-300 active:shadow-none md:w-5/6 lg:w-2/4">
              Baca
          </button>
