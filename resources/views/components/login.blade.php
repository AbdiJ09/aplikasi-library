 <dialog id="modalLogin" class="modal">
     <div class="p-4 bg-black rounded-lg w-[22rem] md:w-99 -ms-3 text-start bg-no-repeat bg-cover border border-violet-900 shadow-xl shadow-violet-900"
