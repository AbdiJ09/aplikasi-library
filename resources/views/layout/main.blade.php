<!DOCTYPE html>
<html lang="en" data-theme="{{ Request::is('/') ? 'dark' : 'light' }}">
...
<head>
    ...
    <style>
        :root{
           background: linear-gradient(to right, #480777, #000000 50%, #480777);
        }
    </style>
            ...
            @else
                <div class="flex bg-gradient-to-r from-neutral-200 via-purple-200 to-neutral-100">
                    <x-sidebar link1="Home" link2="Profil" link3="Buku" link4="Peminjaman" link5="pengembalian"
                        href1="{{ route('home') }}" href2="{{ route('profil') }}" href3="{{ route('buku') }}" />
