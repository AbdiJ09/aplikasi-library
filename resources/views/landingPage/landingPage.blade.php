...
@push('content')
    <div class="w-full invert-0 landing bg-cover bg-bottom flex flex-col justify-center items-center h-screen overflow-x-hidden"
        ...
        <section class="relative
                    mx-auto max-w-2xl py-32 px-10 sm:py-48 lg:py-56">
            <img src="{{ asset('img/satur.png') }}" alt=""
                class="absolute top-[50%] -translate-y-1/2 -z-20 left-2/4 -translate-x-2/4">
            <div class="text-center">
                <h1 class="text-5xl font-bold md:tracking-[3rem] tracking-[0.5rem]  text-white md:text-6xl">
                    library
                </h1>
                <p class="mt-4 text-sm md:text-lg leading-5 text-white">Like the boundless stars in the night sky,
                    knowledge opens
                    a
