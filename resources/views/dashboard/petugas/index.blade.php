...
@section('content')
    <div class="container py-10 px-5">
        ...
        @endif
        <h1 class="text-white"><i class="fa-solid fa-table-columns"></i> Page /
            {{ Request::is('dashboard/petugas') ? 'Petugas' : '' }}</h1>
        <form action="{{ Request::is('dashboard') ? route('dashboard') : route('petugas.index') }}">
            ...
            <div class="relative">
                ...
                <input type="search" id="default-search"
                    ...
                    placeholder="Cari petugas..." name="searchPetugas" value="{{ request('searchPetugas') }}">
            ...
            <div class="relative">
                <div class=" h-auto p-4 bg-zinc-300 rounded-xl">
                    ...
                    <div class="flex justify-center items-center space-x-2 lg:space-x-4">
                        ...
                        <h3 class="lg:text-xl text-neutral-700">2</h3>
                    </div>
                </div>
        ...
        <x-dashboard.table :petugas="$petugas" />
    </div>
@endsection
